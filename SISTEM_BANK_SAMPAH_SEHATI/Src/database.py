...
# ================= FUNGSI DATABASE =================
def tambah_produk(nama: str, harga: int, stok: int, deskripsi: str):
    cursor.execute(
...
def simpan_user(user_id: int, full_name: str, username: str):
    cursor.execute("""
...
def simpan_laporan(user_id: int, full_name: str, message=None, photo_file_id=None, latitude=None, longitude=None):
    cursor.execute("""
